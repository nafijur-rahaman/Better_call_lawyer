...
const Counter = () => {
    return (
        ...
        <div className="heading">
            <h1 className='text-4xl font-bold text-center'>We Provide Best Law Services</h1>
            <p className='w-2/4 mx-auto py-3 text-[#0F0F0F80]'>We have a good team of lawyers, we will provide you with the best services.</p>
        </div>

            <div className="counter-card-container grid grid-cols-1 md:grid-cols-4 mt-5">
